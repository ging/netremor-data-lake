...
object BronzeToSilver {
  def main(args: Array[String]): Unit = {
    ...
    val dataPath = "D:/Archivos_uni/TFM/netremor-data-lake/src/main/scala/org/tfmupm/data"
    ...
    // Por cada sujeto, se guardan sus tareas en una tabla dependiendo de si son de tipo Ambulatory o Continuous
